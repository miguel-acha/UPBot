...
{
    /**
     * n8n: constancia (resumen, no datos sensibles)
     */
    ...
    public function myResponses(Request $request)
    {
        ...
        // OJO: en tu BD la columna es sensitivity_level, no "sensitivity".
        // Para el front, devolvemos un alias "sensitivity".
        $items = ResponsePayload::with('interaction')
            ...
            ->paginate(20, [
                ...
                'summary',
                'sensitivity_level as sensitivity',
                'created_at',
            ]);
    ...
    public function showResponse(Request $request, ResponsePayload $payload)
    {
        ...
        return response()->json([
            ...
            'sensitivity' => $payload->sensitivity_level, // alias para el front
